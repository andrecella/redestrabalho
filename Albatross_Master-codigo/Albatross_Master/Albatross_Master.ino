...
void RelayToggle2(int value){
  ...
  // "/RoboCore/relay/<serial_number>/<relay_number>/<relay_state>"
  ...
  XBeeMessages::CreateRemoteATRequest(&barray, "0013A20040A670C9", "0000", USE_64_BIT_ADDRESS, D0, tosend);
  
  Serial.println("barray and tosend");
  ...
  int resp = 0;
  resp = XBeeMessages::ResponseStatus(API_REMOTE_AT_COMMAND_REQUEST, str);
  
  Serial.print("------------------------------------------- res");
  Serial.println(ByteToHexChar(resp));
